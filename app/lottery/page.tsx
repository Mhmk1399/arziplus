...
function generateFAQSchema() {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "لاتاری گرین کارت آمریکا یک قرعه کشی سالانه است که افراد واجد شرایط را انتخاب میکند تا اقامت دائم ایالات متحده را دریافت کنند.",
    },
    {
    ...
    {
      question: "شرایط و مدارک لازم ثبت نام  چیست؟",
      answer:
        "برای ثبت نام  با ارزی پلاس کافی است: مشخصات فردی، عکس لاتاری استاندارد، پرداخت هزینه ثبت نام . نیازی به ارسال مدارک تحصیلی، شغلی یا زبان در مرحله ثبت نام  نیست.",
    },
    {
      question: "چه افرادی واجد شرایط شرکت در لاتاری هستند؟",
      answer:
        "افرادی که در کشور مجاز به ثبت نام  متولد شدهاند و دارای حداقل مدرک دیپلم یا دو سال سابقه کار معتبر هستند، میتوانند ثبت نام  کنند.",
    },
    {
      question: "شرایط فرزندان برای ثبت در زیر مجموعه چیست؟",
      answer:
        "فرزندان زیر ۱۸ سال باید به عنوان زیرمجموعه والدین ثبت شوند. فرزندان بین ۱۸ تا ۲۱ سال میتوانند هم در فرم والدین باشند و هم بهصورت مستقل ثبت نام  کنند.",
    },
    {
    ...
    // AdditionalFAQs data
    {
      ...
      answer:
        "کافی است به پلتفرم رسمی ثبت نام  لاتاری ارزی پلاس مراجعه کرده و فرم را تکمیل کنید.",
    },
    {
      question: "روش افزایش شانس برنده شدن وجود دارد؟",
      answer:
        "هیچ روشی قطعی برای افزایش شانس وجود ندارد؛ اما افراد متأهل میتوانند با ثبت نام  دوشانسه، شانس خود را دو برابر کنند.",
    },
    {
      question: "تاریخ و روند اعلام نتایج چیست؟",
      answer:
        "نتایج قرعه کشی معمولاً در اواسط اردیبهشت ماه منتشر میشوند. در صورتی که برنده شوید، تیم ارزی پلاس مراحل بعدی مهاجرت و ویزا را برای شما پیگیری میکند.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "ارزی پلاس با تیم متخصص، مجوزهای معتبر و سابقه موفق در امور مهاجرتی، تمامی مراحل ثبت نام ، بررسی فرم، ترجمه، عکاسی، و کارگزاری امور برندگان را به صورت کاملاً حرفهای انجام میدهد.",
    },
    {
      question: "خدمات ارزی پلاس چیست؟",
      answer:
        "ثبت نام  کامل لاتاری، مشاوره پیش از ثبت نام ، بررسی اطلاعات و رفع ایرادات، ترجمه به انگلیسی، اصلاح عکس، پشتیبانی ۲۴ ساعته، ارسال PDF تأییدیه، اعلام نتایج و کارگزاری کامل پرونده برندگان.",
    },
  ];
