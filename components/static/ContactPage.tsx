...
const ContactPage = () => {
  ...
  const contactFaq = [
    ...
    },
    {
      ...
      answer:
        "مشاوره تخصصی، راهنمایی افتتاح حساب، پرداخت های بینالمللی، ثبت شرکت و تمام خدمات ارزی.",
      category: "خدمات",
    },
    {
      id: "5",
...
تیم پشتیبانی ما همیشه آماده پاسخگویی به پرسشها، درخواست ها و راهنمایی در خصوص خدمات بینالمللی است — از پرداخت هزینه آزمونها گرفته تا افتتاح حساب بانکی خارجی یا ثبت شرکت در کشورهای معتبر.
